...
public sealed partial class MainWindow : Window
{
    ...
    private void HighlightNav(Type pageType)
    {
        Button? active = pageType == typeof(OverviewPage) ? NavOverview
            ...
            : null;
        foreach (var button in new[] { NavOverview, NavCleaner, NavRegistry, NavWindowsCleanup, NavAppCleanup, NavInstalledApps, NavStartupApps, NavSecureDelete, NavActivity, NavSchedules, NavSettings, NavUpdates })
